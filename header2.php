...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="#!"><span class="color1">Computer Science</span></a></li>
  <li class="divider"></li>
  <li><a href="#!"><span class="color2">Electrical and Electronics</span></a></li>
  <li class="divider"></li>
  <li><a href="#!"><span class="color1">Electronics and Communication</span></a></li>
  <li class="divider"></li>
  <li><a href="#!"><span class="color2">Mechanical Engineering</span></a></li>
  <li class="divider"></li>
  <li><a href="#!"><span class="color1">Civil Engineering</span></a></li>
...
<nav>
  <div class="nav-wrapper hello">
    <a href="#!" class="left brand-logo"><i></i>VIT RESEARCH</a>
